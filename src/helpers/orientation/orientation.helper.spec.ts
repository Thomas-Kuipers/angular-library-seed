...
describe('OrientationHelper', () => {
  ...
  it('should emit true when we test for portrait, and the user is in portrait (android style)', async(() => {
    configureTestbed({
      screen: {
        orientation: {
  ...
  it('should emit false when we test for portrait, but the user is in landscape (android style)', async(() => {
    configureTestbed({
      screen: {
        orientation: {
  ...
  it('should emit true when we test for landscape, and the user is in landscape (iOS style)', async(() => {
    configureTestbed({
      orientation: 90
    });
  ...
  it('should emit false when we test for landscape, but the user is in portrait (iOS style)', async(() => {
    configureTestbed({
      orientation: 0
    });
  ...
  it('should emit true when we test for landscape, and we have no way to detect orientation', async(() => {
    configureTestbed({});
