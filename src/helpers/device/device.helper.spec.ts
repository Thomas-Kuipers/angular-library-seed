...
describe('DeviceHelper', () => {
  ...
  it(
    'should emit false when we test for mobile, but the user is on an ipad',
    async(() => {
  ...
  it(
    'should emit true when we test for tablet, and the user is on an ipad',
    async(() => {
      configureTestbed(ipad);
  ...
  it(
    'should emit false when we test for tablet, but the user is on an iphone',
    async(() => {
  ...
  it(
    'should emit true when we test for mobile, and the user is on an iphone',
    async(() => {
      configureTestbed(iphone);
  ...
  it(
    'should emit false when we test for desktop, but the user is on an iphone',
    async(() => {
      configureTestbed(iphone);
  ...
  it(
    'should emit true when we test for desktop, and the user is on macOS chrome',
    async(() => {
  ...
  it(
    'should emit true when we test for either desktop or tablet, and the user is on macOS chrome',
    async(() => {
      configureTestbed(macOSChrome);
  ...
  it(
    'should emit true when we test for either mobile or tablet, and the user is on an iphone',
    async(() => {
      configureTestbed(iphone);
  ...
  it(
    'should emit false when we test for either mobile or tablet, but the user is on macOS chrome',
    async(() => {
      configureTestbed(macOSChrome);
