...
import {
  ScreenWidthHelper,
  ScreenWidthSpec
} from './helpers/screen-width/screen-width.helper';
import { IfMinScreenWidthDirective } from './directives/if-min-screen-width';
  ...
  public static forRoot(
    ...
    return {
      ...
      providers: [
        ...
        WindowRefHelper,
        {
          provide: USER_AGENT_STRING,
          useValue: config.userAgentString || defaultUserAgentString
        },
        {
          provide: DEBOUNCE_TIME,
          useValue: config.debounceTime || defaultDebounceTime
        },
        {
          provide: SCREEN_WIDTH_BREAKPOINTS,
          useValue: config.screenWidthBreakpoints || defaultScreenWidths
        },
